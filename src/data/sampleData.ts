...
export const sampleCustomers: Customer[] = [
  { id: '1', name: 'أحمد بن علي', phone: '22123456', points: 150, creditBalance: 25.500, createdAt: new Date('2024-01-15') },
  { id: '2', name: 'محمد الصالح', phone: '55987654', points: 80, creditBalance: 0, createdAt: new Date('2024-02-20') },
  { id: '3', name: 'فاطمة الزهراء', phone: '99456789', points: 200, creditBalance: 15.000, createdAt: new Date('2024-03-10') },
];
